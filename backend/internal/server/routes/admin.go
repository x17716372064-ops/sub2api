...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/upstream-account-balance", h.Admin.Account.GetUpstreamAccountBalance)
		...
		accounts.PUT("/:id/upstream-account-balance", h.Admin.Account.SaveUpstreamAccountBalance)
		accounts.POST("/:id/upstream-account-balance/refresh", h.Admin.Account.RefreshUpstreamAccountBalance)
