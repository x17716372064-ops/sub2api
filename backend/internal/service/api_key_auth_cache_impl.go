...
const apiKeyAuthSnapshotVersion = 21 // v21: include group lowest-rate scheduling preference (force refresh of pre-fix snapshots)
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			PreferLowestRateAccount:         apiKey.Group.PreferLowestRateAccount,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			PreferLowestRateAccount:         snapshot.Group.PreferLowestRateAccount,
