...
func init() {
	...
	// groupDescPreferLowestRateAccount is the schema descriptor for prefer_lowest_rate_account field.
	groupDescPreferLowestRateAccount := groupFields[3].Descriptor()
	// group.DefaultPreferLowestRateAccount holds the default value on creation for the prefer_lowest_rate_account field.
	group.DefaultPreferLowestRateAccount = groupDescPreferLowestRateAccount.Default.(bool)
