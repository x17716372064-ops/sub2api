...
// PreferLowestRateAccount applies equality check predicate on the "prefer_lowest_rate_account" field. It's identical to PreferLowestRateAccountEQ.
func PreferLowestRateAccount(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldPreferLowestRateAccount, v))
}
...
// PreferLowestRateAccountEQ applies the EQ predicate on the "prefer_lowest_rate_account" field.
func PreferLowestRateAccountEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldPreferLowestRateAccount, v))
}

// PreferLowestRateAccountNEQ applies the NEQ predicate on the "prefer_lowest_rate_account" field.
func PreferLowestRateAccountNEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldPreferLowestRateAccount, v))
}
