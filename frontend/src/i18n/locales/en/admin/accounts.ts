export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        adapter: 'Upstream rate adapter',
        adapterNone: 'Native Sub2API (default)',
        adapterNewAPI: 'New API pricing endpoint',
        adapterCustomJSON: 'Custom JSON endpoint',
        adapterHint: 'Use this when the upstream is not the original Sub2API or the native probe reports “Unsupported”. Paths stay on the current upstream host.',
        path: 'Rate endpoint path',
        pathHint: 'Use a same-host path beginning with /, for example /api/pricing. Do not enter a full URL.',
        ratePath: 'JSON rate path',
        ratePathHint: 'Use dot-separated JSON fields, such as group_ratio or data.rate. Numeric array indexes are also supported.',
        group: 'Upstream group name',
        groupPlaceholder: 'for example codex-special',
        groupHint: 'Required for New API pricing; the multiplier is read from group_ratio for this group. Leave blank for custom JSON when the path directly returns a number.',
        pathRequired: 'Enter the upstream rate endpoint path',
        pathInvalid: 'Invalid upstream rate endpoint path: use a same-host / path without a full URL, .., query, or fragment',
        ratePathRequired: 'Enter a valid JSON rate path',
        groupRequired: 'New API pricing requires an upstream group name'
      },
      upstreamAccountBalance: {
        title: 'Upstream Website Balance',
        hint: 'Enter the upstream website, email, and password to sign in and query the balance when saving. New API-compatible sites are supported; the password is encrypted server-side and write-only.',
        website: 'Upstream website',
        websitePlaceholder: 'https://your-upstream.example.com',
        email: 'Upstream email',
        emailPlaceholder: 'Login email',
        password: 'Upstream password',
        passwordPlaceholder: 'Login password',
        passwordKeep: 'Saved; leave blank to keep',
        passwordConfigured: 'Upstream login password saved (not viewable)',
        loading: 'Querying balance…',
        refresh: 'Refresh balance',
        refreshing: 'Refreshing…',
        clear: 'Clear config',
        clearConfirm: 'Clear this account’s upstream balance configuration and saved password?',
        cleared: 'Upstream balance configuration cleared',
        clearFailed: 'Failed to clear upstream balance configuration',
        balance: 'Balance',
        remainingQuota: 'Remaining quota',
        fieldsRequired: 'Upstream website and email are required',
        saved: 'Upstream balance configuration saved',
        saveFailed: 'Failed to save upstream balance configuration',
        refreshSuccess: 'Upstream balance refreshed',
        refreshFailed: 'Failed to refresh upstream balance',
        status: {
          ok: 'Query succeeded',
          failed: 'Query failed',
          unsupported: 'Site does not support this login API',
          notConfigured: 'Not configured'
        },
        errors: {
          login_request_failed: 'Login request failed',
          login_rejected: 'Upstream login rejected',
          login_response_invalid: 'Login response did not contain a usable token',
          balance_request_failed: 'Balance request failed',
          balance_request_rejected: 'Balance endpoint rejected the request',
          balance_fields_not_found: 'No balance fields found in response',
          login_endpoint_unsupported: 'Login endpoint is unsupported',
          balance_endpoint_unsupported: 'Balance endpoint is unsupported'
        }
      },
